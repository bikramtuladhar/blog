---
layout: BookLayout
title: "Valet alternative in Docker"
date: 2022-11-29T00:00:00.000Z
---

# Valet alternative in Docker

Valet is serving great but in some cases, it failed to fulfil the requirement of multiple specific version of PHP and databases. I want to share docker configuration to achieve almost the same configuration as valet using Docker. Below there is a diagram of docker architecture.

![Docker Architecture](https://cdn-images-1.medium.com/max/800/1*C-GM4L83Uf4tV8eKrq-MDQ.png)
...
## Laravel Container docker-compose
...
Setup Traefik as they instructed in official doc. After we set up everything we have to just start laravel container which will be automatically accessible from Traefik automatic discovery.
